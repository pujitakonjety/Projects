...
class RequestGenerator(Thread):
    ...
    def detail_college(self, college_id):
        url = "http://localhost:8080/api/v1/college/" + str(college_id) + "/"
        response = requests.get(url, auth=HTTPBasicAuth('pujitakonjety', 'pujita638'))
    ...
    def run(self):
        ...
        try:
            ...
            if len(colleges) > 0:
                ...
                college_detail = self.detail_college(306)
